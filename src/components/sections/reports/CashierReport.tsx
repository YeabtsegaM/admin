...
export default function CashierReport({ cashierData, loading, selectedShop, sortable = false, sortKey = '', sortDirection = 'asc', onSort, dateRange = '30', startDate = '', endDate = '' }: CashierReportProps) {
  
  const handleDownloadExcel = () => {
    if (cashierData.length === 0) return;
     ...
     },
    {
      ...
      render: (value: unknown, row: any) => (
        <div className="text-sm font-medium text-gray-900">
          {row.cashierName || row.fullName || row.username || 'Unknown Cashier'}
        </div>
      )
    },
    {
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
        <div className="mb-6">
          ...
          <h3 className="text-lg font-medium text-gray-500 mb-2">Select a shop to view cashier data</h3>
  ...
  if (cashierData.length === 0) {
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
        <div className="mb-6">
          ...
          <h3 className="text-lg font-medium text-gray-500 mb-2">No cashier data available</h3>
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <DataTable<any>
        ...
        data={cashierData}
        isLoading={loading}
        emptyMessage="No cashier data found for the selected criteria"
        sortable={sortable}
        sortKey={sortKey}
